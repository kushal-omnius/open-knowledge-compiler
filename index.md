...
Repo: `knowledge-compiler` · Compile run: 2199 · Commit: `57e55e3fb1ed`
...
- [Compilation of Code](feature/compile-command.md)
...
- [Emit Wiki Content](feature/emit-wiki.md)
...
- [Entity Inspection](feature/inspect-command.md)
...
- [Commit Listing](feature/list-commits.md)
...
- [Reconciliation of Merged PRs](feature/reconcile-command.md)
- [Register Repository](feature/register-repository.md)
- [Repository Initialization](feature/register-repository-command.md)
...
- [Read-only MCP Server](feature/serve-command.md)
- [Publisher Protocol](feature/stage-plugin-interface-protocols.md)
- [Knowledge Compilation Management](feature/test-plan-recommendations.md)
...
- [OKF Validation](feature/validate-okf-command.md)
- [Testing Validation](feature/validate-test-command.md)
- [Verify Compilation](feature/verification-of-compilation-state.md)
- [Verification of State](feature/verify-command.md)
...
- [Compile Error Handling](risk/compile-error-handling.md)
- [Error Handling during Repository Initialization](risk/compile-errors.md)
...
- [Database Connection Risk](risk/failed-lock-session.md)
- [Idempotence in Compilation](risk/idempotence-in-compilation.md)
- [Insufficient Handling of Non-conformant Artifacts](risk/insufficient-handling-of-non-conformant-artifacts.md)
- [HTTP Error Handling](risk/lack-of-error-handling-on-api-requests.md)
...
- [Potential for Repository Misconfiguration](risk/potential-for-repository-misconfiguration.md)
...
- [Read-Only Knowledge Base Dependencies](risk/read-only-knowledge-base-dependencies.md)
...
- [Missing Token Error Handling](risk/token-exposure-risk.md)
