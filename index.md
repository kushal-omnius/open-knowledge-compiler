...
Repo: `knowledge-compiler` · Compile run: 3741 · Commit: `b632594b2c40`
...
- [Entity Lookup and Management Tools](feature/entity-lookup-and-management-tools.md)
...
- [Read-only MCP Server](feature/test-plan-recommendations.md)
...
- [Dependency Issues](risk/dependency-issues.md)
...
- [Session Management Risks](risk/session-management-risks.md)
- [Stale Test Coverage](risk/stale-test-coverage.md)
